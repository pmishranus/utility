...
module.exports = {
    ...
    checkIfApproverMatrixEntryExists: function (STF_NUMBER, ULU, FDLU, PROCESS_CODE, STAFF_USER_GRP, VALID_FROM, VALID_TO) {
    ...
    validateAgainstStaffUserGrp: function (STF_NUMBER, ULU, FDLU, PROCESS_CODE, STAFF_USER_GRP1, STAFF_USER_GRP2, STAFF_USER_GRP3) {
        const queryParameter = `  eam.STAFF_ID = '${STF_NUMBER}' and eam.ULU = '${ULU}' and eam.FDLU = CASE WHEN eam.FDLU = 'ALL' THEN eam.FDLU ELSE '${FDLU}' END and eam.PROCESS_CODE = '${PROCESS_CODE}'
        ...
        let validateAgainstStaffUserGrp = cds.run(
            SELECT
                .from(' NUSEXT_UTILITY_CHRS_APPROVER_MATRIX as eam ')
                .where(queryParameter));
