...
service CatalogService @(path: '/catalog') {
  ...
  @readonly entity eclaims_data          as projection on db.ECLAIMS.HEADER_DATA;
  @readonly entity eclaims_items_data    as projection on db.ECLAIMS.ITEMS_DATA;
  @readonly entity tax_benefit_grps      as projection on db.ECLAIMS.TAX_BFT_CLAIMS_GRP;
  @readonly entity cwsned_data           as projection on db.CWNED.HEADER_DATA;
  @readonly entity cwsyearsplit_data     as projection on db.CWNED.YEAR_SPLIT_DATA;
  @readonly entity cwsassistance_data    as projection on db.CWNED.ASSISTANCE_DATA;
  @readonly entity cwspayment_data       as projection on db.CWNED.PAYMENT_DATA;
  @readonly entity opwncons_data         as projection on db.CWNED.OPWN_OTP_CONSOLIDATED_DATA;
  @readonly entity opwnconserr_data      as projection on db.CWNED.OPWN_OTP_CONSOLIDATED_ERR_DATA;
  @readonly entity opwnpayimg_data       as projection on db.CWNED.OPWN_PAYMENT_IMG_DATA;
  @readonly entity appconfig_data        as projection on db.UTILITY.APP_CONFIGS;
  entity attachments_data      as projection on db.UTILITY.ATTACHMENTS_DATA;
  @readonly entity auditlog_data         as projection on db.UTILITY.AUDIT_LOG_DATA;
  ...
  @readonly entity claimdurationcfg_data as projection on db.UTILITY.CLAIM_REQUEST_DURATION_CONFIG;
  ...
  @readonly entity datetoweek_data       as projection on db.UTILITY.DATE_TO_WEEK;
  @readonly entity emailcfg_data     as projection on db.UTILITY.EMAIL_CONFIGS;
