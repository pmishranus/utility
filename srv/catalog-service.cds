...
service CatalogService @(path: '/catalog') {
  ...
  entity paramentries_data  as projection on db.MASTER_DATA.CHRS_PARAM_ENTRIES;
  entity payrollarea_data   as projection on db.MASTER_DATA.CHRS_PAYROLL_AREA;
  entity papsa_data         as projection on db.MASTER_DATA.CHRS_ULU_FDLU_PA_PSA;
  entity emplist_data       as projection on db.MASTER_DATA.EMPLOYEE_LIST;
  entity emplistconcur_data as projection on db.MASTER_DATA.EMPLOYEE_LISTING_CONCUR;
  entity claimtypemaster_data as projection on db.MASTER_DATA.MASTER_CLAIM_TYPE;
